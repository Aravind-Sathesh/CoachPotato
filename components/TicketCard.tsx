...
import { buildGoogleCalendarUrl } from '@/utils/ticketDate';
...
export function TicketCard({ ticket, onDelete }: TicketCardProps) {
  const calendarUrl = buildGoogleCalendarUrl(ticket);
      ...
      <div className='px-5 pb-5 pt-0'>
        <div className='bg-zinc-950/50 rounded-xl p-4 border border-white/5'>
          ...
          <div className='flex flex-wrap gap-2'>
            ...
            <div className='flex items-center bg-zinc-900 border border-zinc-800 rounded-full pl-1 pr-1 py-1 shadow-sm'>
              {ticket.coach && (
                <div className='text-xs font-bold text-zinc-400 mx-2 flex items-center gap-1'>
